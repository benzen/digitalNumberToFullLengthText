...
def numberToWord =  [ 0:"zero", 1:"un", 2:"deux",3:"trois",4:"quatre",5:"cinq", 6:"six",7:"sept",8:"huit",9:"neuf",                                         10:"dix",11:"onze",12:"douze",13:"treize",14:"quatorze",15:"quinze",16:"seize",
...
def coumpondNumberToString = { counted, multiple = null, optionalOne=false->
    if(!counted) return ""
    if( optionalOne && multiple  && ( counted == numberToWord.get(1) ) ) return multiple 
...
def convert = { number ->
    ...
    def thousandsAsString = numberStringToString( convertUpToThousand(thousands), upperNumberToWord.get(1000), true )
